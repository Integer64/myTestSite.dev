...
class VecktorVersion2 extends Vecktor{
    ...
    public function __construct()
    {
        ...
        foreach($this->allDepartments as $department){
            ...
            $this->upgradeAnalysts($employees, $department);
        }
    }

    private function upgradeAnalysts(SplObjectStorage $employees, Department $department)
    {
